...
app.add_middleware(
    CORSMiddleware,
    # during development the HMI may run on various ports (3000+, 5173, etc.)
    # allow all localhost origins or use '*' in a production-safe way.
    allow_origins=["http://localhost", "http://localhost:3000", "http://localhost:3001", "http://localhost:3002", "http://localhost:5173"],
